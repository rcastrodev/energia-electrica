<div class="modal fade" id="modal-create-beneficio">
    <form action="{{ route('company.content.createInfo') }}" method="post" class="modal-dialog" data-info="reset" data-asyn="no" enctype="multipart/form-data">
        @csrf
